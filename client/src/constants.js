...
export const productList = [
  ...
  { product_id: 3, product_name: 'Corona de metal sinterizado', price: 100, description: 'La durabilidad superior de la corona de metal sintetizado, hecha de una innovadora aleación perfecta para pacientes alérgicos al cobalto.', category: 'Fijas', images: [imgCoronaMetalSintetizado1, imgCoronaZirconio2, imgCoronaZirconio3] },
